...
(use-package general
  ...
  (cxn/leader-def
    ...
    "pa"    '("switch all". projectile-switch-project)
    "pd"    '("dirs"      . projectile-find-dir)
    "pf"    '("files"     . projectile-find-file)
    "pg"    '("git"       . magit-project-status)
    "pm"    '("dired"     . projectile-dired)
    "pp"    '("switch"    . projectile-switch-open-project)
    "p/"    '("search"    . projectile-ripgrep)
    "p>"    '("vterm"     . projectile-run-vterm)
    "p!"    '("shell"     . projectile-run-shell-command-in-root)
    "pb"    (cons "buffers" (make-sparse-keymap))
    "pbb"     '("switch"  . projectile-switch-to-buffer)
    "pbl"     '("list"    . projectile-display-buffer)
    "pbk"     '("kill"    . projectile-kill-buffers)
    "pbs"     '("save"    . projectile-save-project-buffers)
